set :application, "acrosoft.ro"
set :location, "acrosoft.ro"
set :repository,  "git@github.com:dragontech/acrosoft.git"
set :branch, "master"
  ...
  task :config_virtual_host do
    virtual_host_config =<<-EOF
      <VirtualHost 178.79.139.120:80>
        ServerAdmin admin@acrosoft.ro
        ServerName acrosoft.ro
        ServerAlias www.acrosoft.ro
        DocumentRoot /srv/www/acrosoft.ro/current/public_html/
        ErrorLog /srv/www/logs/acrosoft.ro/error.log     
        CustomLog /srv/www/logs/acrosoft.ro/access.log combined
      </VirtualHost>
    EOF
